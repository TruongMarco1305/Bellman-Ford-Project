...
\begin{tabular}{ccc}
	...
	\multicolumn{3}{c}{\textbf{{\Huge \textcolor{blue}{Bellman-Ford Algorithm In}}}}\\
	\\
    ...
    \multicolumn{1}{r}{\textbf{\Large Instructor(s):}} & \multicolumn{2}{l}{\Large Nguyen Van Minh Man, \textit{Mahidol University}} \\ \\
